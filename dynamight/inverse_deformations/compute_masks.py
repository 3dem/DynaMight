...
from .rigid import get_rotation_translation, initialize_masks
...
def compute_masks_for_rigid_transforms(
    ...
    new_star = initialize_masks(
        encoder_half1, decoder_half1, data_loader_half1, poses, data_preprocessor, star_file, half=1)
